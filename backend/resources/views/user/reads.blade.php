        ...
        <div class="row">
          <div class="col-md-12 d-inline-flex">
            <div class="d-block user_show_btns">
              <a href="{{ route("user.reads", ["user" => $user]) }}" class="btn btn-light user_show_btn read_btn_active">
          ...
          <div class="col-md-6 col-sm-10 h-100 w-100">
            <div class="card flex-row mb-4 shadow border h-md-250 user_show_cardbody">
              <div class="card-body d-flex flex-column align-items-start">
                <strong>
                  <a href="{{ route("book.show", ["book" => $read -> book]) }}">{{ $read -> book -> title }}</a>
                </strong>
                ...
                <p class="mb-0small">
                  出版社：{{ $read -> book -> publisher_name }}
                </p>
                <p class="mb-0 small">
                  発売日：{{ $read -> book -> sales_date }}
                </p>
                <p>
                  {{ $read -> comment }}
                </p>
